...
class writeexcel_worksheet extends writeexcel_biffwriter
{
    ...
    protected $_print_rowmax;
    protected $_print_colmin;
    protected $_print_colmax;
    ...
    protected $_protect;
    protected $_password;
    protected $_col_sizes;
    protected $_row_sizes;
    protected $_col_formats;
    protected $_row_formats;
    protected $_zoom;
     ...
     * @return array
     */
    public function getDimensions(&$row_min = null, &$col_min = null, &$row_max = null, &$col_max = null)
    {
     ...
     */
    public function _close($sheetnames)
    {
     ...
     */
    public function set_first_sheet()
    {
     ...
     */
    public function set_paper($type)
    {
     ...
     */
    public function set_header($string, $margin)
    {
     ...
     */
    public function set_footer($string, $margin)
    {
        if (strlen($string) >= 255) {
     ...
     */
    public function center_horizontally($hcenter = 1)
    {
     ...
     * Center the page horizontally.
     */
    public function center_vertically($vcenter = 1)
    {
     ...
     */
    public function set_margins($margin)
    {
     ...
     */
    public function set_margins_LR($margin)
    {
        $this->set_margin_left($margin);
        $this->set_margin_right($margin);
    }
     ...
     */
    public function set_margins_TB($margin)
    {
        $this->set_margin_top($margin);
        $this->set_margin_bottom($margin);
    }
     ...
     */
    public function set_margin_left($margin = 0.75)
    {
     ...
     */
    public function set_margin_right($margin = 0.75)
    {
     ...
     */
    public function set_margin_top($margin = 1.00)
    {
     ...
     */
    public function set_margin_bottom($margin = 1.00)
    {
     ...
     */
    public function repeat_columns()
    {
        $_ = func_get_args();
     ...
     */
    public function print_row_col_headers($headers = 1)
    {
     ...
     */
    public function set_h_pagebreaks($breaks)
    {
     ...
     */
    public function set_v_pagebreaks($breaks)
    {
     ...
     */
    public function set_zoom($scale = 100)
    {
     ...
     */
    public function set_print_scale($scale = 100)
    {
        // Confine the scale to Excel's range
        if ($scale < 10 || $scale > 400) {
     ...
     */
    public function _XF($row = false, $col = false, $format = false)
    {
        if ($format) {
     ...
     */
    public function _substitute_cellref($_)
    {
     ...
     */
    public function _cell_to_rowcol($cell)
    {
     ...
     */
    public function _sort_pagebreaks($breaks)
    {
     ...
     */
    public function _encode_password($plaintext)
    {
     ...
     */
    public function write_url_range()
    {
        $_ = func_get_args();
     ...
     * See also write_url() above for a general description and return values.
     */
    public function _write_url_web()
    {
        $_ = func_get_args();
     ...
     * See also write_url() above for a general description and return values.
     */
    public function _write_url_internal()
    {
        $_ = func_get_args();
     ...
     * See also write_url() above for a general description and return values.
     */
    public function _write_url_external()
    {
        $_ = func_get_args();
     ...
     * See also write_url() above for a general description and return values.
     */
    public function _write_url_external_net()
    {
        $_ = func_get_args();
     ...
     */
    public function _store_window2()
    {
     ...
     * length record.
     */
    public function _store_colinfo($_)
    {
     ...
     */
    public function _store_selection($_)
    {
     ...
     */
    public function _store_externcount($cxals)
    {
     ...
     */
    public function _store_externsheet($sheetname)
    {
     ...
     */
    public function _store_panes($_)
    {
     ...
     */
    public function _store_hcenter()
    {
     ...
     */
    public function _store_vcenter()
    {
     ...
     */
    public function _store_margin_left()
    {
     ...
     */
    public function _store_margin_right()
    {
     ...
     */
    public function _store_margin_top()
    {
     ...
     */
    public function _store_margin_bottom()
    {
     ...
     */
    public function _store_print_headers()
    {
     ...
     */
    public function _store_print_gridlines()
    {
     ...
     */
    public function _store_gridset()
    {
     ...
     * protected.
     */
    public function _store_protect()
    {
     ...
     */
    public function _store_password()
    {
     ...
     */
    public function _position_image($col_start, $row_start, $x1, $y1, $width, $height)
    {
     ...
     */
    public function _store_obj_picture($col_start, $x1, $row_start, $y1, $col_end, $x2, $row_end, $y2)
    {
     ...
     */
    public function _process_bitmap($bitmap)
    {
